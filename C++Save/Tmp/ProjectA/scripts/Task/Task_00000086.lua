...
function Task_00000086(npcId)
	...
	if task:GetTaskAcceptNpc(86) == npcId and Task_Accept_00000086 () then
		...
		action.m_ActionMsg = task_msg_359;
...
function Task_00000086_step_01()
	...
	action.m_NpcMsg = task_msg_362;
	action.m_ActionMsg = task_msg_363;
	return action;
end
...
function Task_00000086_step_02()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_364;
	action.m_ActionMsg = task_msg_365;
	return action;
end
