...
function Task_00000071(npcId)
	...
	if task:GetTaskAcceptNpc(71) == npcId and Task_Accept_00000071 () then
		...
		action.m_ActionMsg = task_msg_2107;
...
function Task_00000071_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_2110..GetPlayerName(GetPlayer())..task_msg_2111;
...
function Task_00000071_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_2113;
	action.m_ActionMsg = "";
	return action;
end
