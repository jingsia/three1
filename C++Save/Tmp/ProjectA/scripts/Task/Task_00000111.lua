...
function Task_00000111(npcId)
	...
	elseif task:GetTaskSubmitNpc(111) == npcId then
		if Task_Submit_00000111() then
			...
			action.m_ActionMsg = task_msg_518;
...
function Task_00000111_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_520..GetPlayerName(GetPlayer())..task_msg_521;
	action.m_ActionMsg = task_msg_522;
	return action;
end
