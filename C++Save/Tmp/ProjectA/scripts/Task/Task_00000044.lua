...
function Task_00000044(npcId)
	...
	if task:GetTaskAcceptNpc(44) == npcId and Task_Accept_00000044 () then
		...
		action.m_ActionMsg = task_msg_308;
...
function Task_00000044_step_01()
	...
	action.m_NpcMsg = task_msg_311;
	action.m_ActionMsg = task_msg_312;
	return action;
end
...
function Task_00000044_step_02()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_313;
	action.m_ActionMsg = task_msg_314;
	return action;
end
